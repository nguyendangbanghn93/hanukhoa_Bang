...
CM.cache({
    ...
    bốCục = new function () {
        ...
        //         }, o);
        //         o.sốBài = o.sốBài || 6;
        //         return $('<div>', { id: '', class: 'pa10', text: '' }).append(
        //             mảng(o.bàiViết).lọc("bàiViết").map(function (i, d) {
        //                 if (d < o.sốBài) {
        //                     d = config("bàiViết." + i) || {};
        //                     return $('<a>', { href: dữLiệu.url(i, "ế"), id: '', class: 'db cl1h', text: '' }).append(
        //                         $('<div>', { id: '', class: 'fwb fs12', icon: "play_arrow::cl1,fs12,bấmĐc", text: dữLiệu.tên(i, "ế") }),
        //                         $('<div>', { id: '', class: 'df jcsb ptb15', text: '' }).append(
        //                             $('<div>', { id: '', class: 'dn-xs pr25', text: dữLiệu.môTả(i, "ế") }).cắtDòng(o.cắtDòng),
        //                             $('<div>', { id: '', class: 'dn-xs c6 fs09 dfn', icon: 'insert_invitation::fs12', text: iDate(d.ậ || d.ấ, "{j}/{n}/{f}") }),
        //                         ),
        //                     );
        //                 }
        //             })
        ...
        //                         }
        //                     };
        //                     return $('<div>', { id: '', class: 'df' + lẻ("", "fdrr"), text: '' }).append(
        //                         $('<div>', { id: '', class: 'w50' + lẻ("br1 bss bcyd", "bl1 bss bcyd"), text: '' }),
        //                         $('<a>', { href: dữLiệu.url(i, "ế"), id: '', class: 'w50 pr' + lẻ("bl1 bss bcyd", "br1 bss bcyd"), text: '' }).append(
        //                             $('<div>', { id: '', class: 'pa t50 fwb fs3 cl1' + lẻ("l0 ttx", "r0 ttx05"), text: '•' }),
        //                             $('<div>', { id: '', class: 'df' + lẻ("fdrr jcfe", "jcfe"), classXs: "pa10,aic", text: '' }).append(
        //                                 $('<div>', { id: '', class: 'sc12hc wh150 bra50 dfn', text: '', classXs: "wh50,-wh150" }).append(
        //                                     $('<div>', { id: '', class: 'bgrn bgpc bgsc bra50 wh150 dfn', classXs: "wh50,-wh150", text: '' }).ảnh(i, "ế", true),
        //                                 ),
        //                                 $('<div>', { id: '', class: 'w40 pa15 plr25', classXs: "-w40,fl1,-plr25,-pa15,pa5", text: '' }).append(
        //                                     $('<div>', { id: '', class: 'fwb fs12 cl1 mb10', classXs: "-fs12", text: dữLiệu.tên(i, "ế") }).cắtDòng(o.cắtTiêuĐề),
        ...
        this.menuReponsive = function () {
            var menu;
            return $('<div>', { id: '', class: 'bg1 plr10 ptb5 bóng ps t0 l0 z5 w1' }).append(
                ...
                $('<div>', { id: '', class: 'df jcsb', text: '' }).append(
                    $('<div>', { id: '', class: 'df aic', text: '' }).append(
                        $('<a>', { href: "/", id: '', class: 'logoMenu' }).append(
                            $("<img>", { class: "", src: "/img/es.hanu.png", height: 30 }),
                        ),
                    ...
                    $('<div>', { id: '', class: 'df aic cf', text: '' }).append(
                        // $('<div>', { id: '', class: 'cf', icon: 'search::fs14,bấmĐc,mr5', text: '' }),
                        $.icon("home::fs14,bấmĐc,mr5").click(function () {
                            vàoURL("/");
                        }),
                        Trang.tìmXs(),
                        $('<div>', { id: '', class: '', icon: 'menu::fs14,bấmĐc,mr5', text: '' }).click(function () {
                            menu.width(300)
                        }),
                    ),
                ),
        ...
        this.menu = function () {
            ...
            //     }
            // })
            return $('<div>', { id: '', class: 'bgcf thanhMenu w1 t0 l0 bóng', text: '' }).append(
                $('<div>', { id: '', class: 'container', text: '' }).append(
                    $('<div>', { id: '', class: 'cb ', text: '' }).append(
                        $('<div>', { id: '', class: 'tar grid cuộnẨn ẩn', text: '' }).append(
                            data.menuTrên.map(function (i, d) {
                                d = config("chuyênMục." + i) || {};
                                return $('<a>', { href: dữLiệu.url(i, "ụ") || "/", id: '', class: 'cb cl1 pa10 plr15 ttu fwb menu', text: d.ê });
                            })
                        ),
                        $('<div>', { id: '', class: 'df aic cuộnẨn ptb10', text: '' }).append(
                            $('<a>', { href: "/", id: '', class: 'logoMenu', text: '' }).append(
                                $("<img>", { src: "/img/es.hanu.png", height: 100 })
                            ),
                ...
                $('<div>', { id: '', class: 'ps z11 t0 bg1 cf mb-1', text: '' }).append( //
                    $("<div>", { class: "container df jcsb dnai dnbi" }).append(
                        data.menuDưới.map(function (i, d) {
                            d = config("chuyênMục." + i) || {};
                            return $('<a>', { href: dữLiệu.url(i, "ụ") || "/", id: '', class: 'pa10 plr15 ttu fwb bgcfh cl1h trans2 menu', text: d.ê || i });
                        })
                    )
                )
            );
        ...
        this.trangChủ = function () {
                        ...
                        $(this).append(
                            $('<div>', { id: '', class: 'container ', text: '' }).append(
                                $('<a>', { href: dữLiệu.url(cm, "ụ"), id: '', class: 'db tac grid', text: '' }).append(
                                    $('<div>', { id: '', class: 'plr40 ptb10 mb40 fwb cf fs15 ttu bra5 bg1', classXs: '-mb40,mb15,-fs15,fs12,-plr40,plr15,-ptb10,ptb3', text: dữLiệu.tên(cm, "ụ") }),
                                ),
                                giaoDiện.timeline({
                    ...
                    return $('<div>', { id: '8931', class: 'bgcf ptb50', text: '', classXs: "-ptb50,ptb25" }).each(function () {
                        ...
                        $(this).append(
                            $('<div>', { id: '', class: 'tac grid', text: '' }).append(
                                $('<a>', { href: dữLiệu.url(cm, "ụ"), id: '', class: 'plr40 ptb10 mb40 fwb cf fs15 ttu bra5 bgcyd', classXs: '-mb40,mb15,-fs15,fs12,-plr40,plr15,-ptb10,ptb3', text: dữLiệu.tên(cm, "ụ") }),
                            ),
                            $('<div>', { id: '', class: 'container', text: '' }).append(
                                $('<div>', { id: '', class: 'df fww jcsb', text: '' }).append(
            ...
            g.s2 = new function () {
                this.s = "s2";
                this.sựKiện = function () {
                    return $('<div>', { id: '7381', class: 'bgce ptb50', text: '', classXs: "-ptb50,ptb25" }).each(function () {
                        var cm = $(this).ID(),
                            div = $('<div>', { id: '', class: 'df fww', text: '' }).xửLý("bàiViết.tải.4", { d: { ụ: cm } }, { cache: true }, function (bvs) {
                                div.append(
                                    $('<div>', { id: '', class: 'col-xs-12 col-md-4 pa10 df aic dn-xs', text: '' }).append(
                                    ...
                                    $('<div>', { id: '', class: 'col-xs-12 col-md-8 df fww', text: '' }).append(
                                        mảng(bvs).map(function (i, d) {
                                            ...
                                            return $('<a>', { href: dữLiệu.url(i, "ế"), id: '', class: 'col-xs-12 col-md-6 df fww ', text: '' }).append(
                                                $('<div>', { id: '', class: 'col-xs-4 col-sm-5 pa10', text: '' }).append(
                                                    $('<div>', { id: '', class: 'bra50 bgrn bgpc bgsc pb1', text: '' }).ảnh(i, "ế", true),
                                                ),
                                                $('<div>', { id: '', class: 'col-xs-8 col-sm-7 pa10 df aic', text: '' }).append(
                                                    $('<div>', { id: '', class: '', text: '' }).append(
                                                        $('<div>', { id: '', class: 'fwb fs12 cl1 mb5 tduh lh13', text: dữLiệu.tên(i, "ế") }).cắtDòng(2),
                                                        $('<div>', { id: '', class: '', text: dữLiệu.môTả(i, "ế") }).cắtDòng(2),
                                                        $('<div>', { id: '', class: 'c6 fs09 tar dfn mt5', icon: 'insert_invitation::fs12', text: iDate(d.ậ || d.ấ, "{j}/{n}/{f}") }),
                                                    ),
                                                ),
                                            )
                                        })
                        ...
                        $(this).append(
                            $('<div>', { id: '', class: 'container ', text: '' }).append(
                                $('<a>', { href: dữLiệu.url(cm, "ụ"), id: '', class: 'db tac grid', text: '' }).append(
                                    $('<div>', { id: '', class: 'plr40 ptb10 mb40 fwb fs15 ttu bra5 tduh', classXs: '-mb40,mb15,-fs15,fs12,-plr40,plr15,-ptb10,ptb3', text: dữLiệu.tên(cm, "ụ") }),
                                ),
                                div
                                // màn("sm") ?
                                //     giaoDiện.danhSách({
                ...
                this.giaoLưuHợpTác = function () {
                    return $('<div>', { id: '8922', class: 'bgce ptb50', text: '', classXs: "-ptb50,ptb25" }).each(function () {
                        var cm = $(this).ID();
                        $(this).append(
                            $('<div>', { id: '', class: 'container', text: '' }).append(
                                $('<a>', { href: dữLiệu.url(cm, "ụ"), id: '', class: 'db tac grid', text: '' }).append(
                ...
                this.cựuSinhViên = function () {
                    return $('<div>', { id: '8931', class: 'bgcf ptb50', text: '', classXs: "-ptb50,ptb25" }).each(function () {
                        ...
                        $(this).append(
                            $('<div>', { id: '', class: 'tac grid', text: '' }).append(
                                $('<a>', { href: dữLiệu.url(cm, "ụ"), id: '', class: 'plr40 ptb10 mb40 fwb fs15 ttu bra5 tduh', classXs: '-mb40,mb15,-fs15,fs12,-plr40,plr15,-ptb10,ptb3', text: dữLiệu.tên(cm, "ụ") }),
                            ),
                            $('<div>', { id: '', class: 'container', text: '' }).append(
                                $('<div>', { id: '', class: 'df fww jcsb', text: '' }).append(
                                    range(0, 1).map(function (j) {
                                        var chuyênLực = mảng(config("chuyênLực." + cm)),
                                            i = chuyênLực[j];
                                        return !i ? "" : $('<a>', { href: dữLiệu.url(i, "ụ"), id: '', class: ' col-xs-12 col-md-5 df pb25-lg', text: '' }).append(
                                            $('<div>', { id: '', class: 'col-xs-5 col-md-6 plr10', text: '' }).append(
                                                $('<div>', { id: '', classM: "pr10", classW: 'pr50', text: '' }).append(
                                                    $('<div>', { id: '', class: 'bgrn bgpc bgsc pb23', text: '' }).ảnh(i, "ụ", true).css({ "box-shadow": là("M") ? "10px 10px #ddd" : "20px 20px #ddd" }),
                                                ),
                                            ),
                                            $('<div>', { id: '', class: ' col-xs-12 col-md-6 plr10 df fdc jcsb', text: '' }).append(
                                                $('<div>', { id: '', class: 'fs15 fs11-xs cl1 fwb tac tal-xs ptb15', text: dữLiệu.tên(i, "ụ") }),
                                                $('<div>', { id: '', class: '', text: dữLiệu.môTả(i, "ụ") }),
                                                $('<a>', { href: dữLiệu.url(i, "ụ"), id: '', class: 'fsi c6 cl1h tar', text: 'Xem thêm' }),
                                            ),
                                        );
            ...
            return [
                $('<div>', { id: '', class: 'pf t50 r0 tty z9 dn', text: '' }).append(
                ...
                $('<div>', { id: '', class: 'pr', text: '' }).append(
                    $('<div>', { id: '', class: 'pa t0 b0 l0 r0 df z9 pen dn', text: '' }).append(
                    ...
                    $('<div>', { id: '', class: 'bgrn bgpc bgsc w1 pr pb249', text: '' }).css({
                        paddingBottom: 764 / 1799 * 100 + "%",
                    }).chờ(function () { $(this).xờLai("/slidebanner_179.json") }, 123)
                ...
                $('<div>', { id: '', class: 'container', text: '' }).append(
                    $('<div>', { id: '', class: 'df fww jcsb pa10', text: '' }).append(
                        $('<div>', { id: '', class: ' col-xs-12 col-md-8 df aic lh15', text: '' }).append(
                            $('<a>', { href: '/', id: '', class: 'dfn dn-xs mr10' }).append(
                                $("<img>", { class: "bgcf bw2 bss bcf bra3", src: "/img/es.hanu.png", height: 100 }),
                            ),
                            $('<div>', { id: '', class: 'cf', text: '' }).append(
                                ...
                                $('<div>', { id: '', class: '', text: 'Điện thoại: (+84 24) 35541794' }),
                                $('<div>', { id: '', class: '', text: 'Email: khoatbn@hanu.edu.vn' }),
                            ),
                        ),
                    ...
                    $('<div>', { id: '', class: 'grid cb', text: '' }).append(
                        $('<div>', { id: '', class: 'col-xs-12 col-sm-9 tac cf', text: 'Copyright © 2021 - Trường Đại học Hà Nội. All Rights Reserved' }),
                        $('<div>', { id: '', class: 'col-xs-12 col-sm-3 tac pt10-xs', text: '' }).append(
                            $('<a>', { href: 'cf5 cfh fs07', title: 'I&E Corp', class: 'cf5 cfh fs07', text: 'Powered by I&E Corp.' }),
                        ),
                    ),
                ),
            );
    ...
    B.empty().append(
        // Trang.library(),
        $('<div>', { id: '', class: 'library', text: '' }).append(
        ...
        bốCục.thân,
        bốCục.footer(),
        $('<div>', { id: '', class: 'back-menutop pf bra50 wh50 z3 bấmĐc bgc05h td2 o05 o1h tpa bgc3 bcd bcf bc2h bss ma5 pa5 cf cl1h df aic jcsc', style: "right: 20px; bottom: 20px", icon: "arrow_upward::fs15", text: '' }).click(function () {
            cuộn(0, 500);
        }),
    );
    tánGẫu.khởiTạo(true)//, { tàiKhoản: ơ,chào:"Xin chào anh Bằng" }
    ...
    //         i:"", //icon
    //         à:"", //ID tài khoản
    //         f:"", //Function (Nếu có funtion thì k khởi tạo chat với tài khoản à, ngược lại)
    //     }
    // ]
    $.each({
    ...
    $(document).on("đổiURL", function (e, u) {
        cl("đổi url", u);
        $(".menu[href='" + u + "']").lớpRiêng("bgcf,cl1");
    });
    vàoURL();
});
